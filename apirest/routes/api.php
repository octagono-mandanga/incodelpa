...
Route::prefix('secretaria')->middleware(['auth:sanctum', 'secretaria'])->group(function () {
...
Route::prefix('coordinacion')->middleware(['auth:sanctum', 'coordinacion'])->group(function () {
...
Route::prefix('root')->middleware(['auth:sanctum', 'root'])->group(function () {
