...
@Component({
  selector: 'app-coordinacion-periodos-add',
  templateUrl: './coordinacion-periodos-add.component.html',
  styleUrls: ['./coordinacion-periodos-add.component.css']
})
export class CoordinacionPeriodosAddComponent implements OnInit {
  public config: any
  ...
  onAgregar(data: any){
    this.loading = true
    this.crudService.create(data, '/coordinacion/periodos').subscribe({
      next: (res: any) => {
