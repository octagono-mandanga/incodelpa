...
@Component({
  selector: 'app-coordinacion-docentes-edit',
  templateUrl: './coordinacion-docentes-edit.component.html',
  styleUrls: ['./coordinacion-docentes-edit.component.css']
})
export class CoordinacionDocentesEditComponent implements OnInit {
  public config: any
  ...
  async ngOnInit() {
    ...
    await this.crudService.read('/coordinacion/docentes/'+this.id).subscribe({
      next: (res: any) => {
        this.data = res.data
